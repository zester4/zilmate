...
const specialistRegistry: Record<string, SwarmAgentConfig> = {
  ...
  enterpriseSales: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Generate outbound sequences (Apollo → HubSpot) and qualify leads via BANT.',
      '2. Schedule demos and handle objection handling with technical stakeholders.',
      '3. Negotiate pricing within predefined guardrails and draft initial term sheets.',
      '4. Coordinate with the Architect for technical pre-sales requirements.',
  ...
  channelManager: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Identify potential reseller/agency/SaaS partners via market research.',
      '2. Build co-marketing and co-selling programs with strategic partners.',
      '3. Track partner-sourced revenue and manage the partner portal.',
      '4. Enable partners with technical training and marketing collateral.',
  ...
  affiliateManager: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Recruit and vet affiliates via Refersion or PartnerStack.',
      '2. Generate unique promo codes/links and manage the distribution of creative assets.',
      '3. Calculate commission payouts and flag fraudulent signups autonomously.',
      '4. Monitor affiliate traffic quality and optimize the referral funnel.',
  ...
  contractAnalyst: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Review MSAs, NDAs, and DPAs for risky clauses or non-standard terms.',
      '2. Suggest redlines based on the company’s legal playbook.',
      '3. Route complex legal disputes to the Legal Counsel for final approval.',
      '4. Manage the execution of documents via DocuSign.',
  ...
  revOps: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Maintain CRM hygiene (deduplication, enrichment) across HubSpot/Salesforce.',
      '2. Build forecast models (Commit vs Pipeline) and calculate LTV/CAC cohorts.',
      '3. Automate the handoff process from Sales to Customer Success.',
      '4. Monitor the "Sales Tech Stack" and ensure all tools are integrated correctly.',
  ...
  redTeam: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Perform autonomous pentesting against company APIs and web infrastructure.',
      '2. Conduct simulated phishing campaigns to audit internal human/agent risk.',
      '3. Search for exposed secrets or misconfigured S3 buckets autonomously.',
      '4. Provide detailed "Attack Path" reports to the Blue Team for remediation.',
      'KPIs: Vulnerabilities discovered, exploitation success rate, and security coverage.',
    ].join('\n'),
    tools: { ...shellTools, ...browserTools },
  ...
  blueTeam: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Monitor production logs for anomalies (brute force, SQL injection, unexpected egress).',
      '2. Configure Web Application Firewalls (WAF) and monitor Sentry for security exceptions.',
      '3. Patch vulnerabilities identified by the Red Team or external bug bounty reports.',
      '4. Conduct regular system hardening audits across the cloud infrastructure.',
  ...
  complianceOfficer: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Map internal workflows to compliance frameworks like SOC2 or ISO 27001.',
      '2. Automate the collection of compliance "Evidence" from GitHub and Vercel.',
      '3. Conduct internal audits of data privacy and access controls.',
      '4. Manage the security questionnaire response process for enterprise deals.',
  ...
  iamArchitect: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Audit permissions across GitHub, AWS, and Composio toolkits.',
      '2. Enforce the "Principle of Least Privilege" for all agents and employees.',
      '3. Manage SSH keys, API tokens, and service account rotations.',
      '4. Investigate unauthorized access attempts or permission escalations.',
  ...
  incidentResponse: {
    ...
    instructions: [
      ...
      'OPERATING PROCEDURES:',
      '1. Orchestrate the "War Room" during a detected security incident.',
      '2. Contain threats by revoking tokens or isolating affected systems autonomously.',
      '3. Conduct post-mortem analyses to prevent recurrence of the breach.',
      '4. Manage stakeholder communication during and after a crisis.',
