...
Custom runner endpoints are scoped to your [organization](./organizations.md) and support the `X-Daytona-Organization-ID` header. Admin endpoints operate across the entire platform and do not require an organization header.
...
Daytona provides methods to create a custom region using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/regions) or programmatically using the [API](../api/README.md#daytona/tag/organizations/POST/regions).
...
> [**createRegion (API)**](../api/README.md#daytona/tag/organizations/POST/regions)
...
Daytona provides methods to list all available regions for your organization using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/regions) or programmatically using the [API](../api/README.md#daytona/tag/organizations/GET/regions).
...
> [**listAvailableRegions (API)**](../api/README.md#daytona/tag/organizations/GET/regions)

### Get a custom region

Daytona provides methods to get the details of a specific region using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/regions) or programmatically using the [API](../api/README.md#daytona/tag/organizations/GET/regions/{id}).
...
> [**getRegionById (API)**](../api/README.md#daytona/tag/organizations/GET/regions/{id})

### Update a custom region

Daytona provides methods to update the configuration of an existing custom region using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/regions) or programmatically using the [API](../api/README.md#daytona/tag/organizations/PATCH/regions/{id}).
...
> [**updateRegion (API)**](../api/README.md#daytona/tag/organizations/PATCH/regions/{id})

### Delete a custom region

Daytona provides methods to delete a custom region using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/regions) or programmatically using the [API](../api/README.md#daytona/tag/organizations/DELETE/regions/{id}). Regions that have runners assigned to them cannot be deleted.
...
> [**deleteRegion (API)**](../api/README.md#daytona/tag/organizations/DELETE/regions/{id})
...
> [**regenerateProxyApiKey (API)**](../api/README.md#daytona/tag/organizations/POST/regions/{id}/regenerate-proxy-api-key)
...
> [**regenerateSshGatewayApiKey (API)**](../api/README.md#daytona/tag/organizations/POST/regions/{id}/regenerate-ssh-gateway-api-key)
...
> [**regenerateSnapshotManagerCredentials (API)**](../api/README.md#daytona/tag/organizations/POST/regions/{id}/regenerate-snapshot-manager-credentials)
...
Daytona provides methods to create a custom runner using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/runners) or programmatically using the [API](../api/README.md#daytona/tag/runners/POST/runners).
...
For more information, see the [API](../api/README.md#daytona/tag/runners) reference:

> [**createRunner (API)**](../api/README.md#daytona/tag/runners/POST/runners)

### List custom runners

Daytona provides methods to list all runners in your organization using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/runners) or programmatically using the [API](../api/README.md#daytona/tag/runners/GET/runners).
...
> [**listRunners (API)**](../api/README.md#daytona/tag/runners/GET/runners)

### Get a custom runner

Daytona provides methods to get the details of a specific runner using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/runners) or programmatically using the [API](../api/README.md#daytona/tag/runners/GET/runners/{id}).
...
> [**getRunnerById (API)**](../api/README.md#daytona/tag/runners/GET/runners/{id})

### Update runner scheduling

Daytona provides methods to update the scheduling status of a runner using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/runners) or programmatically using the [API](../api/README.md#daytona/tag/runners/PATCH/runners/{id}/scheduling). This allows you to mark a runner as unschedulable, preventing new sandboxes from being assigned to it.
...
> [**updateRunnerScheduling (API)**](../api/README.md#daytona/tag/runners/PATCH/runners/{id}/scheduling)

### Delete a custom runner

Daytona provides methods to delete a custom runner using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/runners) or programmatically using the [API](../api/README.md#daytona/tag/runners/DELETE/runners/{id}).
...
> [**deleteRunner (API)**](../api/README.md#daytona/tag/runners/DELETE/runners/{id})
...
For more information, see the [API](../api/README.md#daytona/tag/admin) reference:

> [**adminCreateRunner (API)**](../api/README.md#daytona/tag/admin/POST/admin/runners)
...
> [**adminListRunners (API)**](../api/README.md#daytona/tag/admin/GET/admin/runners)
...
> [**adminGetRunnerById (API)**](../api/README.md#daytona/tag/admin/GET/admin/runners/{id})
...
> [**adminUpdateRunnerScheduling (API)**](../api/README.md#daytona/tag/admin/PATCH/admin/runners/{id}/scheduling)
...
> [**adminDeleteRunner (API)**](../api/README.md#daytona/tag/admin/DELETE/admin/runners/{id})
